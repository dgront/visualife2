...
impl Mindmap {
    pub fn new(id: ElementID, max_node_radius: f32) -> Self {
        Mindmap {
            foot_angle_deg: 30.0,
    ...
    pub fn grow_node(&mut self, id: ElementID, label: &str, angle_deg: f32, parent_node_id: &ElementID) {
        ...
        self.connect_nodes(parent_node_id.clone(), id);
    }
